...
$downloads_table = [
  ...
  ["ncurses" , "5.9"  , false, "ftp://ftp.gnu.org/gnu/ncurses/ncurses-5.9.tar.gz"     , "8cb9c412e5f2d96bc6f459aa8c6282a1", ["binutils *", "gcc *", "newlib *"], "host tarprefix                   ", "--enable-termcap --disable-database --without-cxx --without-cxx-binding", ""            , "all install"                            , "cp config.sub ncurses-5.9/config.sub"                         ],  
  ...
  ["mpfr"    , "3.1.2", false, "ftp://ftp.gnu.org/gnu/mpfr/mpfr-3.1.2.tar.gz"         , "181aa7bb0e452c409f2788a4a7f38476", ["binutils *", "gcc *", "newlib *"], "host tarprefix include oldinclude", "CFLAGS='-fno-stack-protector'"                                          , ""            , "all install"                            , "cp config.sub mpfr-3.1.2/config.sub"                          ],
